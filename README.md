...
## 소개
&nbsp;&nbsp;배려와 공감 프로젝트 with AI는 학생들이 **역할극과 AI와의 상호작용**을 통해  
**배려와 공감의 감정을 이해하고, 실천**할 수 있도록 도와주는 웹 애플리케이션입니다.

## 프로젝트 개요
&nbsp;&nbsp;이 프로젝트는 인공지능(AI)을 활용하여 학교 교육 현장에서 배려와 공감의 가치를 학습하고 실천하는 데 중점을 둔 웹 기반 상호작용 플랫폼입니다.  
&nbsp;&nbsp;교사는 AI의 도움을 받아 몰입도 높은 역할극 투표 상황을 쉽게 생성하고, 학생들은 이 상황에 투표하고 의견을 제시하며 능동적으로 학습에 참여합니다.  
&nbsp;&nbsp;AI가 제공하는 '배려와 공감이 부족한' 시나리오에 직접 피드백하며 올바른 의사소통 방법을 체득하는 것이 목표입니다.

## 기술 스택
&nbsp;&nbsp;**Backend**: Flask (Python)  
&nbsp;&nbsp;**Frontend**: HTML / JavaScript / Jinja  
&nbsp;&nbsp;**Database**: PostgreSQL  
&nbsp;&nbsp;**AI API**: Gemini Flash 2.5 Lite
